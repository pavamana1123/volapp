import './App.css';
import './strings.js'
import Vol from './pages/vol/index.jsx';
import Ser from './pages/ser/index.js';
import API from './api/index.js';
import {Route, BrowserRouter as Router, Routes} from "react-router-dom"
import { useEffect, useState } from 'react';
import Msg from './pages/util/msg/index.js';
import Home from './pages/home/index.js';
import SPOCBLD from './pages/util/spoc-bld/index.js';
import moment from 'moment';
import ServiceList from './pages/util/service-list/index.js';
import AdminInfo from './pages/admin-info/index.js';
import BadgeList from './pages/util/badge/badge-list/index.js';
import SPOCBLDLabel from './pages/util/coupon-label/index.js';
import BadgePrint from './pages/util/badge/badge-print/index.js';
