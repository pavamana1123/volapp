...
*SPOC for Sri Balarama Purnima - Volunteering Services*
...
Volunteering Details – Sri Balarama Purnima – 9th Aug 2025

Hare Krishna 🙏

🌸 Please accept the blessings of Sri Sri Krishna Balarama 🌸
You have been assigned volunteer service for Sri Balarama Purnima. Kindly check your service details by clicking on this link:
...
ISKCON Mysore`.trim())}`
    ...
    "03 - Volunteer Badge Info": (props) => {
        ...
        return Object.keys(voldet).sort().map(n => {
            ...
            return `https://web.whatsapp.com/send?phone=91${v.phone}&name=${encodeURIComponent(v.name)}&text=${encodeURIComponent(`
*Volunteer Badge - Sri Balarama Purnima*
...
ISKCON Mysore`.trim())}`
    ...
    "04 - Service Update Alert for SPOCs": (props) => {
        ...
        return spocs.map(sp => {
            ...
            return `https://web.whatsapp.com/send?phone=91${s.spocPhone}&name=${encodeURIComponent(s.spoc)}&text=${encodeURIComponent(`
*SPOC - Service Update Alert ⚠️ - Sri Balarama Purnima*
...
`.trim())}`
    ...
    "05 - Service Update Alert for Volunteers": (props) => {
        ...
        return Object.keys(voldet).sort().map(n => {
            ...
            return `https://web.whatsapp.com/send?phone=91${v.phone}&name=${encodeURIComponent(v.name)}&text=${encodeURIComponent(`
*Service Update Alert ⚠️ - Sri Balarama Purnima - Volunteering*
...
`.trim())}`
    ...
    "07 - Service Reminder": (props) => {
        ...
        return Object.keys(voldet).sort().map(n => {
            ...
            return `https://web.whatsapp.com/send?phone=91${v.phone}&name=${encodeURIComponent(v.name)}&text=${encodeURIComponent(`
Service Reminder 🌟 - Sri Balarama Purnima - Volunteering 🙌
...
ISKCON Mysore 🌸`.trim())}`
    ...
    "08 - General Info": (props) => {
        ...
        return Object.keys(voldet).sort().map(n => {
            ...
            return `https://web.whatsapp.com/send?phone=91${v.phone}&name=${encodeURIComponent(v.name)}&text=${encodeURIComponent(`
⭐ *Important Info - Sri Balarama Purnima - Volunteering*
